...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-template="vertical-menu-template-free">
  <head>
    ...
    <title>Login | Result Processing Platform for BPSC Exams</title>

    <meta name="description" content="Login with BPSC RP PLATFORM." />
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center">
                <h4 class="mb-2">RP PLATFORM for BPSC</h4>
