...
<div class="action-buttons">
    ...
    @if($edit != false )
        <span x-data="{ editContentPlaceholder: 'Loading...', loadEditContent: async function() {
            ...
            <a class="btn btn-sm btn-primary" href="{{ url('edit-issue-data/' . $id . '/' . $model) }}" data-bs-toggle="modal" data-bs-target="#myModalEdit-{{ $id }}"  x-on:click="loadEditContent()" id="edit-btn-{{ $id }}">Solve</a>
